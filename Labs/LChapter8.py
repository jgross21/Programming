...
ball_1_x = 620
ball_1_y = 330
right_wing_y_position = 410
right_wing_up_speed = 5
ball_speed = 3
right_wing_down_speed = 3
right_bruise = 0
left_wing_y_position = 410
font_size = 10
openess = 3
...
while not done:
    ...
    # --- Game logic should go here
        ...
        right_wing_y_position -= right_wing_up_speed
    if right_wing_y_position >= 250:
        right_wing_up_speed = 0
        right_wing_down_speed = 3
        right_wing_y_position -= right_wing_down_speed
    ...
    if right_bruise == 0:
        RIGHT_ARM_COLOR = (255, 255, 0)
    if right_bruise == 1:
        RIGHT_ARM_COLOR = (237, 207, 61)
    if right_bruise == 2:
        RIGHT_ARM_COLOR = (209, 182, 54)
    if right_bruise == 3:
        RIGHT_ARM_COLOR = (114, 112, 84)
    if right_bruise == 4:
        RIGHT_ARM_COLOR = (109, 84, 114)
    if right_bruise >= 5:
        RIGHT_ARM_COLOR == (85, 55, 91)
    ...
    pygame.draw.polygon(screen, RIGHT_ARM_COLOR, [[(screen_width / 2) + 150, (screen_height / 2) -100], [(screen_width / 2)+ 130, (screen_height / 2) +31], [670, right_wing_y_position]])
    pygame.draw.polygon(screen, BLACK, [[(screen_width / 2) + 150, (screen_height / 2) -100], [(screen_width / 2)+ 130, (screen_height / 2) +31], [670, right_wing_y_position]], 3)

    pygame.draw.polygon(screen, YELLOW, [[(screen_width / 2) - 150, (screen_height / 2) -100], [(screen_width / 2)- 130, (screen_height / 2) +31], [30, left_wing_y_position]])
    pygame.draw.polygon(screen, BLACK, [[(screen_width / 2) - 150, (screen_height / 2) -100], [(screen_width / 2)- 130, (screen_height / 2) +31], [30, left_wing_y_position]], 3)
    ...
    pygame.draw.ellipse(screen, BLACK, [260, 100, 50, 50], openess)

    pygame.draw.ellipse(screen, LAVENDER, [380, 100, 50, 50])
    pygame.draw.ellipse(screen, BLACK, [380, 100, 50, 50], openess)
    ...
    pygame.draw.ellipse(screen, NAVY, [ball_1_x, ball_1_y, 50, 50])
